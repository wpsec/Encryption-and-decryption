...
def decodes(decode,value):
	...
	if(decode in decode_dict):
		...
		exit(0)
	if(number == 1):
		value = decsha(value,dectype='md5')
		return value
	elif(number == 2):
		value = decsha(value,dectype='md4')
		return value
	elif(number == 3):
		value = decsha(value,dectype='sha512')
		return value
	elif(number == 4):
		value = decsha(value,dectype='sha1')
		return value
	elif(number == 5):
		value = decsha(value,dectype='sha384')
		return value
	elif(number == 6):
		value = decsha(value,dectype='sha224')
		return value
	elif(number == 7):
		value = decsha(value,dectype='sha256')
		return value
	elif(number == 8):
